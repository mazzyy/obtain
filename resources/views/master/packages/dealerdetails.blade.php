                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="sort" data-sort="Locality">Cell/phone #</th>
                                            <th scope="col" class="sort" data-sort="Locality">joining Date</th>
                                    ...
                                    <tbody class="list">
                                        ...
                                        @foreach ($dealerDetails as $details)
                                            <tr>
                                                <th scope="row">
                                                    <div class="media-body">
                                                        <i class="bg-warning"></i>
                                                        <span class="name mb-0 text-sm"> {{ $details->Name }}</span>
                                                    </div>
                                                </th>
                                                <td class="budget">
                                                    {{ $details->address }}
                                                ...
                                                <td>
                                                    <span class="badge badge-dot mr-4">
                                                        ...
                                                        <span class="status">{{ $details->contact }}</span>
                                                    </span>
                                                </td>
                                                ...
                                                <td>
                                                    <span class="badge badge-dot mr-4">
                                                        ...
                                                        <span class="status">{{ $details->joiningDate }}</span>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-dot mr-4">
                                                        ...
                                                        <div class="col-md-12">
                                                                ...
                                                                <div class=" row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label>Cnic</label>
                                                                            <input type="text" class="form-control" maxlength="13" name="CNIC" placeholder="Cnic" id="Cnic" required=""  >
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label>Address</label>
                                                                            <input type="text" class="form-control" name="address" placeholder="Description" id="add">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row ">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="date" name="joiningDate" class="form-control " placeholder="mm/dd/yyyy" data-provide="datepicker" id="jDate"    maxlength="10">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input  disabled="disabled" type="date" class="form-control  " placeholder="mm/dd/yyyy"  name="leavingDate" data-provide="datepicker" id="ldate" maxlength="10" >
                                                                        </div>
                                                                    </div>
                                                                </div>
