                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                ...
                                <button href=""  class=" mt-3 mb-3 mr-2 pr-3 btn btn-icon   btn-default btn-sm" type="button">
                                    ...
                                    <span class="btn-inner--text" data-toggle="modal" data-target="#modal-form">Add new</span>
                                </button>
                            </div>
                        </div>
              ...
              <div class="card-body px-lg-5 py-lg-5">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="Country" type="text"  list="country" name="country" />
                        <datalist id="country">
                          ...
                          @endforeach
                              ...
                              <div class="form-group mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="City" type="text"  list="city" />
                                      <datalist id="city">
                       ...
                       <div class="form-group mb-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control" placeholder="locality" type="text"  list="locality" name="locality" />
                       ...
                       <div class="form-group mb-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control" placeholder="sublocality" type="text" list="sublocality" name="sublocality" />
